...
//list middleware 
//This middleware ensures that at least 
//the title and tags fields are always included in the response.
...
const list = (req, res, next) => {
    ...
    //sets fields to title and tags
    req.fields === undefined ? 
    (req.fields = fields) : (req.fields = Object.assign(req.fields, fields))
    next() //passes control to the next middleware or route handler.
}

//setUserFilter Middleware
//This middleware filters results to only include items 
